jQuery(document).ready(function ($) {
    ...
    function renderAccountItem(obj) {
        $('.fffMetaBoxAccounts').html(`<div class="fff-metabox-accounts-empty"><i class="fas fa-plus" 
                    ...
                    switch (key) {
						case 'wordpress': 
							...
							element.forEach(ele => {
								...
								$('.fffMetaBoxAccounts').append(buildHtmlShareAccount(key, info , _icon, _name));
							})	
							break;
						case 'facebook':
        ...
        $('.fffMetaBoxTab.schedule').on('click', function () {
            let tab_type = $(this).data('tab');
            $('.fffMetaBoxTab.schedule').removeClass('fff-is-active');
            $(this).addClass('fff-is-active');
            // $('.fff-add-schedule').attr('data-type', tab_type);
            $('.ffffMetaBoxAccountsEmpty').attr('data-type', tab_type);
            $('.saveScheduleBtn').attr('data-type', tab_type);
